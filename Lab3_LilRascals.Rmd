...
cdc <- as_tibble(cdc)
ggplot(data = cdc) +
  geom_bar(mapping = aes(x = as.factor(smoke100), fill = gender)) +
  xlab("Response") +
  ylab("People") +
